...
const HomeLayout = () => {
  return (
    <div className="flex w-full gap-2 justify-center items-start">
      <div className="hidden lg:flex max-w-[348px] w-full max-h-[calc(100vh-140px)] h-full bg-bgColor-custom rounded-md overflow-y-auto flex-col items-center py-3 max-[1200px]:w-[300px]">
        <StocksList />
      </div>
